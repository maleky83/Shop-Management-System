...
namespace Program.Data.Migrations
{
    ...
    [Migration("20260730101911_init-mg")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Program.Data.Entities.Category.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Program.Data.Entities.Category.CategoryToProduct", b =>
                {
            ...
            modelBuilder.Entity("Program.Data.Entities.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Program.Data.Entities.Order", b =>
                {
            ...
            modelBuilder.Entity("Program.Data.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Program.Data.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Program.Data.Entities.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Program.Data.Entities.Category.CategoryToProduct", b =>
                {
                    b.HasOne("Program.Data.Entities.Category.Category", "Category")
                        .WithMany("CategoryToProducts")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Program.Data.Entities.Product", "Product")
                        .WithMany("CategoryToProducts")
            ...
            modelBuilder.Entity("Program.Data.Entities.Order", b =>
                {
                    b.HasOne("Program.Data.Entities.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Program.Data.Entities.OrderDetail", b =>
                {
                    b.HasOne("Program.Data.Entities.Order", "Order")
            ...
            modelBuilder.Entity("Program.Data.Entities.Product", b =>
                {
                    b.HasOne("Program.Data.Entities.Item", "Item")
                        .WithOne("Product")
                        .HasForeignKey("Program.Data.Entities.Product", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
