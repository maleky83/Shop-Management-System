...
namespace ShopManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260916131447_InitMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopManagementSystem.Domain.Entities.Identity.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopManagementSystem.Domain.Entities.Identity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopManagementSystem.Domain.Entities.Identity.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("ShopManagementSystem.Domain.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "a",
                            PasswordHash = "AQAAAAIAAYagAAAAEGXenaaSLxper4UJoQ+gez+Olv2R2siuXVFVzUk4rVVfRukD/vbVe17dsaU8PNLtgw==",
                            RoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("ShopManagementSystem.Domain.Entities.Identity.RolePermission", b =>
                {
                    b.HasOne("ShopManagementSystem.Domain.Entities.Identity.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopManagementSystem.Domain.Entities.Identity.Role", "Role")
                        .WithMany("RolePermissions")
